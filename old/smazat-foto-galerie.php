...
$query = Db::delete('fotogalerie_fotky', $where_delete);	

// smažeme z disku
unlink('../fotky/galerie/male/'.$_GET['f']);
unlink('../fotky/galerie/velke/'.$_GET['f']);

$data_insert_log = array(
					    'id_admin' => $_SESSION['admin']['id'],
					    'uz_jm' => $_SESSION['admin']['uz_jm'],
					    'udalost' => 'Fotogalerie - smazání fotky u galerie s ID: '.intval($_GET['id_g']),
