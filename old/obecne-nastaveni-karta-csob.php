...
if($_GET['action']=='update')
{
	...
	else
	{
		if($_GET['id'])
		{
			...
			{
				echo '<div class="alert-warning">Chyba!<br>Žádný záznam v databázi pro id '.strip_tags($_GET['id']).'<br><a href="./index.php?p=obecne-nastaveni">Přejít na přehled</a></div>';
			}
...
else
{
	...
	$tabulka = new Vypisy('obecne_nastaveni','typ=4','','nazev',array('id','nazev','obsah'),array('Id','Název','Obsah','Akce'),1,0,0);
